...
public class MaskRequestUrlParamHandler implements UrlParamHandler<MaskRequestParams> {
    ...
    public MaskRequestUrlParamHandler(HttpServletRequest request, BigInteger[] defaultDestinationIdArray,
    ...
    public void store(MaskRequestParams params) {
        ...
        session.setAttribute("maskedDestinationId[]",
    ...
    public MaskRequestParams materialize() {
        ...
        MaskingRequestStatus[] statusArray = (MaskingRequestStatus[]) session.getAttribute("maskedRequestStatus[]");
