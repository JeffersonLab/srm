...
import org.jlab.hco.business.params.SignoffActivityParams;
...
public class SignoffActivityUrlParamHandler implements UrlParamHandler<SignoffActivityParams> {
    ...
    public SignoffActivityUrlParamHandler(HttpServletRequest request,
    ...
    public SignoffActivityParams materialize() {
        ...
        SignoffChangeType[] changeArray = (SignoffChangeType[]) session.getAttribute("activityDetailChange[]");
     ...
     */
    @Override
    public void redirect(HttpServletResponse response, SignoffActivityParams params) throws
            IOException {
