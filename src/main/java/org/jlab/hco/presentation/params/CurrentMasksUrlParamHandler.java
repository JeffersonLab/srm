...
public class CurrentMasksUrlParamHandler implements UrlParamHandler<CurrentMasksParams> {
    ...
    public CurrentMasksUrlParamHandler(HttpServletRequest request,
    ...
    public void store(CurrentMasksParams params) {
        ...
        session.setAttribute("currentMasksDestinationId[]",
        ...
        session.setAttribute("currentMasksStatusId[]",
    ...
    public CurrentMasksParams defaults() {
        ...
        defaultParams.setStatusIdArray(new BigInteger[]{Status.MASKED.getStatusId(), Status.MASKED_CC.getStatusId()});
     ...
     */
    @Override
    public void redirect(HttpServletResponse response, CurrentMasksParams params) throws
            IOException {
