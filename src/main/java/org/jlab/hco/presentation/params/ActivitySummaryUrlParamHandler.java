...
public class ActivitySummaryUrlParamHandler implements UrlParamHandler<ActivitySummaryParams> {
    ...
    public ActivitySummaryUrlParamHandler(HttpServletRequest request,
                                          BigInteger[] defaultDestinationIdArray, BeamDestinationFacade destinationFacade,
                                          CategoryFacade categoryFacade,
                                          SystemFacade systemFacade, RegionFacade regionFacade) {
    ...
    public void store(ActivitySummaryParams params) {
        ...
        session.setAttribute("activitySummaryDestinationId[]",
    ...
    public ActivitySummaryParams materialize() {
        ...
        BigInteger[] categoryIdArray = (BigInteger[]) session.getAttribute(
                "activitySummaryCategoryId[]");
        BigInteger[] systemIdArray
                = (BigInteger[]) session.getAttribute("activitySummarySystemId[]");
        BigInteger[] regionIdArray
                = (BigInteger[]) session.getAttribute("activitySummaryRegionId[]");
     ...
     */
    @Override
    public void redirect(HttpServletResponse response, ActivitySummaryParams params) throws
            IOException {
