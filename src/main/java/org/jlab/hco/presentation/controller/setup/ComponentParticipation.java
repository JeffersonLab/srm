 ...
 * @author ryans
 */
@WebServlet(name = "ComponentParticipation",
...
public class ComponentParticipation extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        BigInteger[] colDestinationIdArray = ParamConverter.convertBigIntegerArray(request,
                "colDestinationId");
        ...
        List<Component> componentList
                = componentFacade.findWithDestinations(destinationId, categoryId, systemId, regionId,
                componentName, offset, maxPerPage);
        Long totalRecords = componentFacade.countFilterList(new BigInteger[]{destinationId}, categoryId, systemId, regionId, null,
                null, null, null, null, componentName, null);
        ...
        String filters
                = FilterSelectionMessage.getMessage(selectedDestinationList, selectedCategory, selectedSystem,
                selectedRegion, null, null, null, null, componentName, null, null);
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/setup/component-participation.jsp").forward(
                request, response);
    }
}
