...
import org.jlab.hco.business.params.ActivitySummaryParams;
...
import org.jlab.hco.persistence.model.ActivitySummaryRecord;
import org.jlab.hco.presentation.params.ActivitySummaryUrlParamHandler;
 ...
 * @author ryans
 */
@WebServlet(name = "Signoff Summary", urlPatterns = {"/reports/signoff-summary"})
public class SignoffSummary extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ActivitySummaryUrlParamHandler paramHandler = new ActivitySummaryUrlParamHandler(request,
        ...
        List<ActivitySummaryRecord> activitySummaryList = signoffActivityFacade.findSummaryList(
        ...
        if (activitySummaryList != null) {
            ...
            total
                    = new ActivitySummaryRecord(BigInteger.ZERO, "Total", upgradeReady,
                    upgradeChecked, downgradeChecked, downgradeNotReady, cascade, comment);
            grandTotal = upgradeReady + upgradeChecked + downgradeChecked + downgradeNotReady
                    + cascade + comment;
        }
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/reports/signoff-summary.jsp").forward(request, response);
    }
}
