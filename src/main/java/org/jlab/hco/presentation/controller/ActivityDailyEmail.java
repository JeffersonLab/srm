 ...
 * @author ryans
 */
@WebServlet(name = "ActivityDailyEmail", urlPatterns = {"/activity-daily-email"})
public class ActivityDailyEmail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        params.setCurrentComponentStatusIdArray(new BigInteger[]{BigInteger.valueOf(50), BigInteger.valueOf(100)});
        ...
        if (activityList.isEmpty()) {
            willNotBeSentMessage = "There is no notable activity";
        }
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/activity-daily-email.jsp").forward(request, response);
    }
}
