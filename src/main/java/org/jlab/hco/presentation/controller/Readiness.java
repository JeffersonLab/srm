...
import org.jlab.hco.business.params.ReadinessParams;
import org.jlab.hco.business.params.RecentActivityParams;
import org.jlab.hco.business.service.RecentActivityService;
...
import org.jlab.hco.persistence.model.SignoffActivityCompressedRecord;
import org.jlab.hco.presentation.params.ReadinessUrlParamHandler;
 ...
 * @author ryans
 */
@WebServlet(name = "Readiness", urlPatterns = {"/readiness"})
public class Readiness extends HttpServlet {

    @EJB
    ComponentTreeFacade treeFacade;
    @EJB
    ...
    protected void doGet(HttpServletRequest request,
        ...
        ReadinessUrlParamHandler paramHandler
                = new ReadinessUrlParamHandler(request, destinationFacade,
                categoryFacade, systemFacade, regionFacade,
                groupFacade, statusFacade);
        ...
        List<BeamDestination> destinationList
                = destinationFacade.findAll(new OrderDirective(
                "weight"));
        ...
        Long maskedCount = componentFacade.countMasked(params.getDestinationIdArray(), params.getCategoryId(), params.getSystemId(),
                params.getRegionId(), params.getGroupId(), null, params.getStatusIdArray());
        Long componentCount = componentFacade.countFilterList(
                params.getDestinationIdArray(), params.getCategoryId(),
                params.getSystemId(), params.getRegionId(),
                params.getGroupId(), BigInteger.ONE, null, null, null,
                null, params.getStatusIdArray());

        RecentActivityParams recentParams = new RecentActivityParams(
                ...
                params.getRegionId(), params.getGroupId(),
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/readiness.jsp").forward(request, response);
    }
}
