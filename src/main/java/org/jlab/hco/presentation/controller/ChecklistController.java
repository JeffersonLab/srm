...
import org.jlab.hco.business.session.StaffFacade;
import org.jlab.hco.persistence.entity.Checklist;
import org.jlab.hco.persistence.entity.GroupResponsibility;
import org.jlab.hco.persistence.entity.Staff;
import org.jlab.hco.presentation.util.HcoFunctions;
 ...
 * @author ryans
 */
@WebServlet(name = "ChecklistController", urlPatterns = {"/checklist"})
public class ChecklistController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/checklist.jsp").forward(request, response);
    }

    private void setChecklist(HttpServletRequest request, BigInteger checklistId, BigInteger groupId, BigInteger systemId) throws ServletException {
        Checklist checklist;
        ...
        if (checklistId == null) {
            ...
            if (responsibility == null) {
                throw new ServletException("No responsibility for groupId " + groupId + " and systemId " + systemId);
            }

            if (responsibility.getChecklist() != null) {
                throw new ServletException("Checklist already exists for groupId " + groupId + " and systemId " + systemId);
            }
