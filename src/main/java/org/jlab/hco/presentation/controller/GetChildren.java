 ...
 * @author ryans
 */
@WebServlet(name = "GetChildren", urlPatterns = {"/get-children"})
public class GetChildren extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            GetChildren.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (nodeId != null && type != null) {
            children = treeFacade.findChildren(type, nodeId, destinationIdArray, categoryId, systemId, regionId, groupId, statusIdArray);
        } else {
            rootNode = true;
