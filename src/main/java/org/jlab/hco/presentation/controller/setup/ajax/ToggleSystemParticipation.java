 ...
 * @author ryans
 */
@WebServlet(name = "ToggleSystemParticipation", urlPatterns = {"/setup/ajax/toggle-system-participation"})
public class ToggleSystemParticipation extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            ToggleSystemParticipation.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            BigInteger systemId = ParamConverter.convertBigInteger(
                    request, "systemId");
            BigInteger applicationId = ParamConverter.convertBigInteger(
                    request, "applicationId");

            applicationFacade.toggle(systemId, applicationId);
