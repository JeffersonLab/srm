...
public class Components extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            componentList = componentFacade.findMustFilter(categoryIdArray, systemIdArray, q, regionId, componentId, destinationId, applicationId, max, offset, autoWild);

            if (max != null) {
                totalRecords = componentFacade.countMustFilter(categoryIdArray, systemIdArray, q, regionId, componentId, destinationId, applicationId, autoWild, max);
            } else {
