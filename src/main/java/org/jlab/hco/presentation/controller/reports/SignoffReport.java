...
import org.jlab.hco.business.params.SignoffReportParams;
...
import org.jlab.hco.persistence.model.SignoffReportRecord;
import org.jlab.hco.presentation.params.SignoffReportUrlParamHandler;
 ...
 * @author ryans
 */
@WebServlet(name = "Signoff Report", urlPatterns = {"/reports/signoff"})
public class SignoffReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        SignoffReportUrlParamHandler paramHandler = new SignoffReportUrlParamHandler(request,
        ...
        List<SignoffReportRecord> recordList = signoffFacade.filterSignoffReportRecordList(
                params.getDestinationIdArray(), params.getCategoryId(), params.getSystemId(),
                params.getRegionId(), params.getGroupId(), params.getStatusId(),
                params.isReadyTurn(), params.isMasked(),
                params.getComponentName(), offset, maxPerPage);
        Long totalRecords = signoffFacade.countSignoffReportRecordList(
                params.getDestinationIdArray(),
                params.getCategoryId(),
                params.getSystemId(),
                params.getRegionId(), params.getGroupId(), params.getStatusId(),
                params.isReadyTurn(), params.isMasked(), params.getComponentName());
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/reports/signoff.jsp").forward(request, response);
    }
}
