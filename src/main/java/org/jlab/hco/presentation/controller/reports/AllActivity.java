...
import org.jlab.hco.presentation.params.AllActivityUrlParamHandler;
 ...
 * @author ryans
 */
@WebServlet(name = "All Activity", urlPatterns = {"/reports/all-activity"})
public class AllActivity extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        AllActivityUrlParamHandler paramHandler = new AllActivityUrlParamHandler(request,
        ...
        BigInteger[] systemIdArray = treeFacade.getSystemIdArray(params.getCategoryId(), params.getSystemId());
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/reports/all-activity.jsp").forward(request, response);
    }
}
