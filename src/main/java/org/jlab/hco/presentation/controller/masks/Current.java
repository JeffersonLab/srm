...
import org.jlab.hco.business.params.CurrentMasksParams;
...
import org.jlab.hco.presentation.params.CurrentMasksUrlParamHandler;
 ...
 * @author ryans
 */
@WebServlet(name = "CurrentMasks", urlPatterns = {"/masks/current"})
public class Current extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CurrentMasksUrlParamHandler paramHandler = new CurrentMasksUrlParamHandler(request,
        ...
        List<Component> componentList = componentFacade.filterList(params.getDestinationIdArray(),
                ...
                params.getGroupId(), BigInteger.ONE, null, true,
        ...
        String filters
                ...
                selectedSystem,
                selectedRegion, selectedGroup, selectedStatusList, null,
                params.isUnpowered(), params.getComponentName(), null, null);
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/masks/current.jsp").forward(request, response);
    }
}
