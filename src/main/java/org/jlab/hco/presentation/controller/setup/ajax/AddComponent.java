...
import org.jlab.hco.persistence.util.HcoSqlUtil;
 ...
 * @author ryans
 */
@WebServlet(name = "AddComponent", urlPatterns = {"/setup/ajax/add-component"})
public class AddComponent extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(
            AddComponent.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Throwable integrityCause = HcoSqlUtil.findCause(SQLIntegrityConstraintViolationException.class, e);

            if (integrityCause != null) {
                SQLIntegrityConstraintViolationException dbException = (SQLIntegrityConstraintViolationException) integrityCause;
