 ...
 * @author ryans
 */
@WebServlet(name = "Checklists", urlPatterns = {"/checklists"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (groupId != null) {
                ...
                groupResponsibilityList = groupResponsibilityFacade.filterList(null, null, null, groupId, null, null, 0, 1000);
            ...
            getServletConfig().getServletContext().getRequestDispatcher(
                    "/WEB-INF/views/checklists.jsp").forward(request, response);
        } catch (Exception e) {
