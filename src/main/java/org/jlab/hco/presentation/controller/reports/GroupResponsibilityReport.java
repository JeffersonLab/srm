...
import org.jlab.hco.presentation.params.GroupResponsibilityReportUrlParamHandler;
 ...
 * @author ryans
 */
@WebServlet(name = "GroupResponsibilityReport", urlPatterns = {"/reports/group-responsibility"})
public class GroupResponsibilityReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        GroupResponsibilityReportUrlParamHandler paramHandler
                = new GroupResponsibilityReportUrlParamHandler(request, defaultDestinationIdArray,
                destinationFacade, categoryFacade, systemFacade, groupFacade);
        ...
        List<GroupResponsibility> groupResponsibilityList = groupResponsibilityFacade.filterList(
                params.getDestinationIdArray(), params.getCategoryId(), params.getSystemId(),
                params.getGroupId(), params.isChecklistRequired(),
                params.isChecklistMissing(), offset, maxPerPage);
        Long totalRecords
                = groupResponsibilityFacade.countFilterList(params.getDestinationIdArray(),
                params.getCategoryId(), params.getSystemId(),
                params.getGroupId(),
                params.isChecklistRequired(), params.isChecklistMissing());
        ...
        getServletConfig().getServletContext().getRequestDispatcher(
                "/WEB-INF/views/reports/group-responsibility.jsp").forward(request, response);
    }
}
