...
import org.jlab.hco.persistence.entity.view.ComponentSignoff;
import org.jlab.hco.persistence.enumeration.SignoffChangeType;
import org.jlab.hco.persistence.model.SignoffStandIn;
...
public class GroupSignoffFacade extends AbstractFacade<GroupSignoff> {
    ...
    public List<SignoffStandIn> findStandInListByComponentList(List<Component> componentList) {
        ...
        Query q = em.createQuery(
                "select new org.jlab.hco.persistence.model.SignoffStandIn(a.groupSignoffId, a.componentId, a.groupId, a.modifiedBy, a.modifiedDate, a.changeType, a.comments, a.status) from GroupSignoff a where a.component.componentId in :componentIdList");
