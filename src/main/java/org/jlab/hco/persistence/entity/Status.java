...
import org.jlab.hco.persistence.entity.view.ComponentStatus;
...
public class Status implements Serializable {
    ...
    @Transient
    public static final Status READY = new Status(BigInteger.valueOf(1L), "Ready");
    @Transient
    public static final Status CHECKED = new Status(BigInteger.valueOf(50L), "Checked");
    @Transient
    ...
    @Transient
    public static final Status MASKED_CC = new Status(BigInteger.valueOf(200L), "Masked (Crew Chief)");
    @Transient
    public static final Status MASKED_ADMIN = new Status(BigInteger.valueOf(250L), "Masked (Administrator)");
    ...
    public static Status FROM_ID(BigInteger id) {
        ...
        switch (id.intValue()) {
            ...
            case 250:
                ...
                break;
            default:
                throw new IllegalArgumentException("StatusId must be one of 0, 1, 50, 100, 150, 200, 250.  Found: " + id.intValue());
        }
        return status;
    }
    ...
    public boolean equals(Object object) {
        ...
        return (this.statusId != null || other.statusId == null) && (this.statusId == null || this.statusId.equals(other.statusId));
    }
