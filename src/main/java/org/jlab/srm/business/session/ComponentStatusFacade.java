...
public class ComponentStatusFacade extends AbstractFacade<ComponentStatusRecord> {
     ...
     */
    @PermitAll
    public List<ComponentStatusRecord> filterListOptimized(BigInteger[] destinationIdArray, BigInteger categoryId,
                                                           BigInteger systemId, BigInteger regionId, BigInteger groupId, Boolean unpowered, String componentName,
                                                           int offset, int max) {
        ...
        if (groupId != null) {
            ...
            Join<SystemEntity, GroupResponsibility> responsibilities = system.join(
        ...
        if (ids != null && !ids.isEmpty()) {
            TypedQuery<ComponentStatusRecord> q = em.createQuery(
                    "select a from ComponentStatusRecord a where a.componentId in :idList", ComponentStatusRecord.class);
    ...
    @PermitAll
    public List<ComponentStatusRecord> filterList(BigInteger[] destinationIdArray, BigInteger categoryId, BigInteger systemId,
                                                  BigInteger regionId, BigInteger groupId, BigInteger statusId, Boolean unpowered, String componentName,
                                                  int offset, int max) {
        if (statusId == null) {
            return filterListOptimized(destinationIdArray, categoryId, systemId, regionId, groupId,
                    unpowered, componentName, offset, max);
        }
     ...
     */
    @PermitAll
    public Long countFilterListOptimized(BigInteger[] destinationIdArray, BigInteger categoryId, BigInteger systemId,
                                         BigInteger regionId, BigInteger groupId, Boolean unpowered, String componentName) {
    ...
    @PermitAll
    public Long countFilterList(BigInteger[] destinationIdArray, BigInteger categoryId, BigInteger systemId, BigInteger regionId,
                                BigInteger groupId, BigInteger statusId, Boolean unpowered, String componentName) {
        if (statusId == null) {
            return countFilterListOptimized(destinationIdArray, categoryId, systemId, regionId, groupId,
                    unpowered, componentName);
        }
