...
public class ComponentFacade extends AbstractFacade<Component> {
  ...
  @EJB GroupSignoffFacade groupSignoffFacade;
  ...
  @PermitAll
  public List<Component> filterList(
  ...
  public Component findDetail(String name) {
    TypedQuery<Component> q =
        em.createQuery("select c from Component c where c.name = :name", Component.class);
  ...
  /**
   * For performance reasons this method assumes the group_signoff table is synchronized with the
   * group_action table. This method may give incorrect results if this assumption isn't true. To
   * ensure the tables are in sync call GroupSignoff.updateAndFetchGroupSignOffList before calling
   * this method.
   *
   * @param component
   * @return Status
  ...
  @PermitAll
  public List<Component> findWithDestinations(
  ...
  @PermitAll
  public List<Component> findWithoutSignoff(
      BigInteger[] destinationIdArray,
      BigInteger systemId,
  ...
  @PermitAll
  public List<Component> findMasked(
      BigInteger[] destinationIdArray,
      BigInteger categoryId,
      BigInteger systemId,
      BigInteger regionId,
  ...
  @PermitAll
  public void addNew(
      String name, BigInteger systemId, BigInteger regionId, Boolean masked, String maskedReason)
  ...
  private void setInitialStatus(Component component, SystemEntity system, String username)
      throws UserFriendlyException {
    ...
    if (responsibilityList != null) {
      for (GroupResponsibility gr : responsibilityList) {
        ...
        groupSignoffFacade.updateSignoff(
            componentId,
            group.getGroupId(),
            Status.NOT_READY,
            comment,
            new GroupSignoffFacade.SignoffCascadeRule(),
  ...
  @PermitAll
  public void editMasked(
      BigInteger componentId, Boolean masked, String maskedReason, Date expiration, int maskTypeId)
      throws UserFriendlyException {
    String username = checkAuthenticated();
  ...
  /**
   * Changes a component's system while attempting to maintain signoffs and signoff history.
   *
   * <p>If the old and new system are not the same then check if the old and new systems share any
   * responsible groups. If they do then update the signoffs of the same groups over to the new
   * system. This will require deferring constraints to wait until the end of the transaction.
   *
   ...
   */
  @PermitAll
  public void forceSystemChange(Component component, SystemEntity newSystem, String username)
      throws UserFriendlyException {
  ...
  public void editComponent(
      BigInteger systemId, BigInteger componentId, String name, BigInteger regionId, boolean force)
      throws UserFriendlyException {
    String username = checkAuthenticated();
  ...
  @PermitAll
  public void editException(BigInteger[] componentIdArray, String reason, Date expirationDate)
      throws UserFriendlyException {
    String username = checkAuthenticated();
    ...
    for (BigInteger componentId : componentIdArray) {
      ...
      this.editMasked(
          componentId, masked, reason, expirationDate, Status.MASKED_CC.getStatusId().intValue());
    }
  }

  @PermitAll
  public void removeException(BigInteger[] componentIdArray, Status status, String comment)
      throws UserFriendlyException {
    String username = checkAuthenticated();
  ...
  public void setUnpowered(BigInteger componentId, boolean unpowered) throws UserFriendlyException {
    ...
    // component.getSystem().getGroupResponsibilityList();
    resetSignoffsToNotReady(component, comment, username);
  }

  private void resetSignoffsToMasked(
      Component component, String comment, String username, int maskTypeId) {
  ...
  public void setGroupSignoffToNotReady(
      Component component, ResponsibleGroup group, String comment, String username) {
    Date modifiedDate = new Date();
  ...
  @PermitAll
  public void bulkAddNew(String names, BigInteger systemId, BigInteger regionId)
      throws UserFriendlyException {
  ...
  public void expireMasks() {
    ...
    TypedQuery<Component> q =
        em.createQuery(
            "select c from Component c where c.maskExpirationDate < function('sysdate') ",
            Component.class);
