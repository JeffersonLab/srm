...
public class ChecklistFacade extends AbstractFacade<Checklist> {
  ...
  @PermitAll
  public void saveChanges(BigInteger checklistId, String author, String bodyHtml, String comments)
  ...
  public BigInteger createNew(
      BigInteger groupId, BigInteger systemId, String author, String bodyHtml, String comments)
      throws UserFriendlyException {
  ...
  public Checklist createSpecial(Checklist checklist) {
    ...
    Query q =
        em.createNativeQuery(
            "insert into checklist (checklist_id, body_html, author, modified_date, modified_username, comments) values (?, ?, ?, ?, ?, ?)");
