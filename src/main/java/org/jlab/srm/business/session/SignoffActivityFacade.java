...
public class SignoffActivityFacade extends AbstractFacade<SignoffActivityRecord> {
  ...
  public List<SignoffActivityCompressedRecord> filterListCompressed(
    ...
    CriteriaQuery<SignoffActivityCompressedRecord> cq =
        cb.createQuery(SignoffActivityCompressedRecord.class);
    ...
    if (componentName != null && !componentName.isEmpty()) {
      filters.add(cb.like(cb.lower(root.get("firstComponentName")), componentName.toLowerCase()));
    }
    if (statusId != null) {
    ...
    if (statusIdArray != null && statusIdArray.length > 0) {
      filters.add(root.get("statusId").in(Arrays.asList(statusIdArray)));
  ...
  @PermitAll
  public Long countFilterListCompressed(
      BigInteger[] destinationIdArray,
      BigInteger categoryId,
      BigInteger systemId,
      BigInteger regionId,
  ...
  @PermitAll
  public List<SignoffActivityRecord> filterList(
      BigInteger[] destinationIdArray,
      BigInteger categoryId,
      BigInteger systemId,
      BigInteger regionId,
    ...
    if (componentName != null && !componentName.isEmpty()) {
      filters.add(cb.like(cb.lower(root.get("componentName")), componentName.toLowerCase()));
    }
    if (type != null) {
      filters.add(cb.equal((root.<String>get("changeType")), type));
    }
  ...
  @PermitAll
  public List<ActivitySummaryRecord> findSummaryList(
      BigInteger[] destinationIdArray,
      BigInteger categoryId,
      BigInteger systemId,
      BigInteger regionId,
    ...
    if (resultList != null) {
      for (Object[] row : resultList) {
        ...
        ActivitySummaryRecord summary =
            new ActivitySummaryRecord(
                groupId,
                groupName,
                upgradeReadyCount,
                upgradeCheckedCount,
                downgradeCheckedCount,
                downgradeNotReadyCount,
                cascadeCount,
                commentCount);
