...
public class ComponentBeamDestinationFacade extends AbstractFacade<BeamDestination> {
  ...
  @PermitAll
  public void toggle(BigInteger componentId, BigInteger destinationId)
  ...
  private boolean exists(BigInteger destinationId, BigInteger componentId) {
    Query q =
        em.createNativeQuery(
            "select count(*) from component_beam_destination where beam_destination_id = :destinationId and component_id = :componentId");
  ...
  private void delete(BigInteger destinationId, BigInteger componentId) {
    Query q =
        em.createNativeQuery(
            "delete from component_beam_destination where beam_destination_id = :destinationId and component_id = :componentId");
  ...
  private void insert(BigInteger destinationId, BigInteger componentId) {
    Query q =
        em.createNativeQuery(
            "insert into component_beam_destination (beam_destination_id, component_id) values(:destinationId, :componentId)");
