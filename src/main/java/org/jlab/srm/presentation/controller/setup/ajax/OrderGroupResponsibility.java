 ...
 */
@WebServlet(
    name = "OrderGroupResponsibility",
    urlPatterns = {"/setup/ajax/order-group-responsibility"})
public class OrderGroupResponsibility extends HttpServlet {

  private static final Logger logger = Logger.getLogger(OrderGroupResponsibility.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      BigInteger[] groupResponsibilityIdArray =
          ParamConverter.convertBigIntegerArray(request, "group-responsibility-id[]");
