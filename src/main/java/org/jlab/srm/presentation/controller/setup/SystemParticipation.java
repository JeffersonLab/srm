...
public class SystemParticipation extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<SystemEntity> systemList =
        systemFacade.findWithCategory(categoryId, null, null, null, true, true);
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/setup/system-participation.jsp")
