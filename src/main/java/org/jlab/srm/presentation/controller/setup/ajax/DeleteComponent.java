...
@WebServlet(
    ...
    urlPatterns = {"/setup/ajax/delete-component"})
public class DeleteComponent extends HttpServlet {
  private static final Logger LOGGER = Logger.getLogger(DeleteComponent.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      componentFacade.delete(componentId);
    } catch (EJBAccessException e) {
      LOGGER.log(Level.WARNING, "Not authorized", e);
      errorReason = "Not authorized";
    } catch (UserFriendlyException e) {
      LOGGER.log(Level.WARNING, "Unable to delete component", e);
