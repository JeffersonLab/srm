 ...
 */
@WebServlet(
    name = "UpdateGroupResponsibility",
    urlPatterns = {"/setup/ajax/update-group-responsibility"})
public class UpdateGroupResponsibility extends HttpServlet {

  private static final Logger logger = Logger.getLogger(UpdateGroupResponsibility.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      logger.log(
          Level.FINE, "GroupResponsibilitySystemId: {0}", new Object[] {groupResponsibilityId});
