...
import org.jlab.srm.presentation.params.ComponentReportUrlParamHandler;
...
public class ComponentReport extends HttpServlet {
  ...
  @EJB ComponentStatusFacade componentStatusFacade;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    ComponentReportUrlParamHandler paramHandler =
        new ComponentReportUrlParamHandler(
            request,
    ...
    List<ComponentStatusRecord> componentStatusList =
        componentStatusFacade.filterList(
            ...
            maxPerPage);
    Long totalRecords =
        componentStatusFacade.countFilterList(
            params.getDestinationIdArray(),
            params.getCategoryId(),
            params.getSystemId(),
            params.getRegionId(),
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/reports/component.jsp")
