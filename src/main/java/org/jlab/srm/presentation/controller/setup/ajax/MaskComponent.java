 ...
 * @author ryans
 */
@WebServlet(name = "MaskComponent", urlPatterns = {"/setup/ajax/mask-component"})
public class MaskComponent extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(
            MaskComponent.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            componentFacade.editMasked(componentId, masked, maskedReason, expiration, Status.MASKED_ADMIN.getStatusId().intValue());
