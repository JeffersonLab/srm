 ...
 * @author ryans
 */
@WebServlet(name = "CopyComponentDestination", urlPatterns = {"/grid-copy"})
public class CopyComponentDestination extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            CopyComponentDestination.class.getName());
    @EJB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            BigInteger toComponentId = ParamConverter.convertBigInteger(
                    request, "toComponentId");
            BigInteger fromComponentId = ParamConverter.convertBigInteger(
                    request, "fromComponentId");
