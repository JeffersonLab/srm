 ...
 */
@WebServlet(
    name = "ToggleComponentDestination",
    urlPatterns = {"/setup/ajax/toggle-component-destination"})
public class ToggleComponentDestination extends HttpServlet {

  private static final Logger logger = Logger.getLogger(ToggleComponentDestination.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      componentBeamDestinationFacade.toggle(componentId, destinationId);
