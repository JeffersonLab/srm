 ...
 */
@WebServlet(
    name = "RemoveSavedDowngrade",
    urlPatterns = {"/setup/ajax/remove-saved-signoff"})
public class RemoveSavedSignoff extends HttpServlet {

  private static final Logger logger = Logger.getLogger(RemoveSavedSignoff.class.getName());
