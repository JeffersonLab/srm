...
import org.jlab.srm.presentation.params.MaskCandidatesUrlParamHandler;
...
public class Candidates extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    MaskCandidatesUrlParamHandler paramHandler =
        new MaskCandidatesUrlParamHandler(request, defaultDestinationIdArray);
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/masks/candidates.jsp")
