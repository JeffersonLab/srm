 ...
 */
@WebServlet(
    name = "InventoryActivityReport",
    urlPatterns = {"/reports/inventory-activity"})
public class InventoryAuditReport extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<ApplicationRevisionInfo> transactionList =
        revisionFacade.filterList(params.getStart(), params.getEnd(), offset, maxPerPage);
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/reports/inventory-activity.jsp")
