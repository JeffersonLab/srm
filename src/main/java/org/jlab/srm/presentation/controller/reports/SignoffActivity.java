 ...
 */
@WebServlet(
    name = "Signoff Activity",
    urlPatterns = {"/reports/signoff-activity"})
public class SignoffActivity extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    SignoffActivityUrlParamHandler paramHandler =
        new SignoffActivityUrlParamHandler(
            request,
    ...
    List<SignoffActivityRecord> signoffActivityList =
        signoffActivityFacade.filterList(
            ...
            maxPerPage);
    Long totalRecords =
        signoffActivityFacade.countFilterList(
            params.getDestinationIdArray(),
            params.getCategoryId(),
            params.getSystemId(),
            params.getRegionId(),
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/reports/signoff-activity.jsp")
