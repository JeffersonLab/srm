 ...
 */
@WebServlet(
    name = "ToggleSystemParticipation",
    urlPatterns = {"/setup/ajax/toggle-system-participation"})
public class ToggleSystemParticipation extends HttpServlet {

  private static final Logger logger = Logger.getLogger(ToggleSystemParticipation.class.getName());
