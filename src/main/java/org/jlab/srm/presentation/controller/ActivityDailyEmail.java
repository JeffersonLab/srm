 ...
 */
@WebServlet(
    name = "ActivityDailyEmail",
    urlPatterns = {"/activity-daily-email"})
public class ActivityDailyEmail extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    params.setCurrentComponentStatusIdArray(
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/activity-daily-email.jsp")
