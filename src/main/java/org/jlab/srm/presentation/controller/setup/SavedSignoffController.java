 ...
 */
@WebServlet(
    name = "SavedSignoffController",
    urlPatterns = {"/setup/saved-signoff"})
public class SavedSignoffController extends HttpServlet {

  @EJB private SavedSignoffFacade savedSignoffFacade;
  @EJB private StatusFacade statusFacade;
  @EJB private SystemFacade systemFacade;
  @EJB private ResponsibleGroupFacade groupFacade;
  @EJB private RegionFacade regionFacade;
  @EJB private SavedSignoffTypeFacade typeFacade;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<SavedSignoff> signoffList =
        savedSignoffFacade.filterList(typeId, systemId, groupId, offset, maxPerPage);
    Long totalRecords = savedSignoffFacade.countFilterList(typeId, systemId, groupId);
    List<Status> statusList = statusFacade.findAll(new AbstractFacade.OrderDirective("statusId"));
    ...
    List<SavedSignoffType> typeList =
        typeFacade.findAll(new AbstractFacade.OrderDirective("weight"));
    ...
    String filters =
        FilterSelectionMessage.getSavedSignoffMessage(selectedType, selectedSystem, selectedGroup);
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/setup/saved-signoff.jsp")
