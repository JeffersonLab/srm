 ...
 * @author ryans
 */
@WebServlet(name = "DataComponentList", urlPatterns = {"/data/component-list"})
@Deprecated
public class ComponentList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            componentList = componentFacade.filterList(null, null, systemId, regionId, null, BigInteger.ONE, null, null, null, null, null, false, 0, 10000);
