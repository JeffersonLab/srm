...
import org.jlab.srm.business.params.ComponentSetupParams;
...
import org.jlab.srm.presentation.params.ComponentSetupUrlParamHandler;
 ...
 */
@WebServlet(
    name = "SetupComponentList",
    urlPatterns = {"/setup/component-list"})
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<Component> componentList =
        componentFacade.filterList(
            new BigInteger[] {params.getDestinationId()},
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/setup/component-list.jsp")
