...
@WebServlet(
    name = "SystemActivity",
    urlPatterns = {"/reports/inventory-activity/system-audit"})
public class SystemActivity extends HttpServlet {

  @EJB SystemAudFacade audFacade;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    request
        .getRequestDispatcher("/WEB-INF/views/reports/inventory-activity/system-audit.jsp")
