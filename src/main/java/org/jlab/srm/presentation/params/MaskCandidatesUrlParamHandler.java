...
public class MaskCandidatesUrlParamHandler implements UrlParamHandler<MaskCandidatesParams> {
  ...
  public MaskCandidatesUrlParamHandler(
  ...
  public MaskCandidatesParams defaults() {
    ...
    defaultParams.setStatusIdArray(
        new BigInteger[] {Status.NOT_READY.getStatusId(), Status.CHECKED.getStatusId()});
  ...
  public MaskCandidatesParams materialize() {
    ...
    HttpSession session = request.getSession(true);
    BigInteger[] destinationIdArray =
        (BigInteger[]) session.getAttribute("exceptionsDestinationId[]");
    ...
    BigInteger[] statusIdArray = (BigInteger[]) session.getAttribute("exceptionsStatusId[]");
   ...
   */
  @Override
  public void redirect(HttpServletResponse response, MaskCandidatesParams params)
      throws IOException {
