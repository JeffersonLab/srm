...
public class AllActivityUrlParamHandler implements UrlParamHandler<AllActivityParams> {
  ...
  public AllActivityUrlParamHandler(
  ...
  public AllActivityParams convert() {
    ...
    BigInteger[] currentComponentStatusIdArray =
        ParamConverter.convertBigIntegerArray(request, "componentStatusId");
    BigInteger[] currentSignoffStatusIdArray =
        ParamConverter.convertBigIntegerArray(request, "currentSignoffStatusId");
  ...
  public void store(AllActivityParams params) {
    ...
    session.setAttribute(
        "allChange[]",
        params.getChangeArray() == null ? new AllChangeType[0] : params.getChangeArray());
    ...
    session.setAttribute(
        ...
        params.getCurrentComponentStatusIdArray() == null
            ? new BigInteger[0]
            : params.getCurrentComponentStatusIdArray());
    session.setAttribute(
  ...
  public AllActivityParams materialize() {
    ...
    BigInteger[] currentComponentStatusIdArray =
        (BigInteger[]) session.getAttribute("activityDetailCurrentComponentStatusId[]");
    BigInteger[] currentSignoffStatusIdArray =
        (BigInteger[]) session.getAttribute("activityDetailCurrentSignoffStatusId[]");
  ...
  public String message(AllActivityParams params) {
    ...
    if (params.getCurrentComponentStatusIdArray() != null) {
      currentComponentStatusList =
          statusFacade.findMultiple(params.getCurrentComponentStatusIdArray());
    }
   ...
   */
  @Override
  public void redirect(HttpServletResponse response, AllActivityParams params) throws IOException {
