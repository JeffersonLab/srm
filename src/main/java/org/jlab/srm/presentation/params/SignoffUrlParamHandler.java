...
public class SignoffUrlParamHandler implements UrlParamHandler<SignoffParams> {
  ...
  public SignoffParams defaults() {
    ...
    defaultParams.setStatusIdArray(
        new BigInteger[] {BigInteger.ONE, BigInteger.valueOf(50L), BigInteger.valueOf(100L)});
   ...
   */
  @Override
  public void redirect(HttpServletResponse response, SignoffParams params) throws IOException {
