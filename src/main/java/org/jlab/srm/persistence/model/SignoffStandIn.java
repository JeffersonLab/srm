...
/**
 * In order to avoid the overhead of JPA pulling in the group responsibility OneToMany relationships
 * in the GroupSignoff entity we created this stand-in class.
 *
 * @author ryans
 */
public class SignoffStandIn {
  ...
  public SignoffStandIn(
      BigInteger groupSignoffId,
      BigInteger componentId,
      BigInteger groupId,
      String modifiedBy,
      Date modifiedDate,
      SignoffChangeType changeType,
      String comments,
      Status status) {
