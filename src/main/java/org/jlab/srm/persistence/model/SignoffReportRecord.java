...
/**
 * In order to handle scenario where a group_signoff record is implicit due to the
 * group_responsibility table, but isn't actually present we use the component_signoff view and this
 * model object.
 *
 * @author ryans
 */
