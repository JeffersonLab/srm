...
public class MaskingRequest implements Serializable {
  ...
  @Id
  @SequenceGenerator(
      name = "MaskingRequestId",
      sequenceName = "MASKING_REQUEST_ID",
      allocationSize = 1)
  ...
  public boolean equals(Object object) {
    ...
    return (this.maskingRequestId != null || other.maskingRequestId == null)
        && (this.maskingRequestId == null || this.maskingRequestId.equals(other.maskingRequestId));
  }

  @Override
  public String toString() {
    return "org.jlab.srm.persistence.entity.MaskingRequest[ maskingRequestId="
        + maskingRequestId
        + " ]";
  }
}
