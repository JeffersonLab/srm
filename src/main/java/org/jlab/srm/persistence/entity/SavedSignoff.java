...
public class SavedSignoff implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "SavedSignoffId", sequenceName
            = "SAVED_SIGNOFF_ID", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator
            = "SavedSignoffId")
    @Basic(optional = false)
    @NotNull
    @Column(name = "SAVED_SIGNOFF_ID", nullable = false, precision = 22, scale
            = 0)
    ...
    @JoinColumn(name = "FILTER_STATUS_ID", referencedColumnName = "STATUS_ID", nullable
            = true)
    @ManyToOne(optional = true, fetch = FetchType.EAGER)
    private Status filterStatus;
    @JoinColumn(name = "FILTER_REGION_ID", referencedColumnName = "REGION_ID", nullable
            = true)
    @ManyToOne(optional = true, fetch = FetchType.EAGER)
    private Region region;
    @JoinColumn(name = "FILTER_SYSTEM_ID", referencedColumnName = "SYSTEM_ID", nullable
            = false)
    @ManyToOne(optional = false, fetch = FetchType.EAGER)
    @NotNull
    private SystemEntity system;
    @JoinColumn(name = "FILTER_GROUP_ID", referencedColumnName = "GROUP_ID", nullable
            = false)
    @ManyToOne(optional = false, fetch = FetchType.EAGER)
    @NotNull
    private ResponsibleGroup group;
    @JoinColumn(name = "SIGNOFF_STATUS_ID", referencedColumnName = "STATUS_ID", nullable
            = false)
    @ManyToOne(optional = false, fetch = FetchType.EAGER)
    @NotNull
    private Status signoffStatus;
    @JoinColumn(name = "SAVED_SIGNOFF_TYPE_ID", referencedColumnName = "SAVED_SIGNOFF_TYPE_ID", nullable
            = false)
    @ManyToOne(optional = false, fetch = FetchType.EAGER)
    @NotNull
    ...
    public boolean equals(Object object) {
        ...
        return (this.savedSignoffId != null || other.savedSignoffId == null) && (this.savedSignoffId == null || this.savedSignoffId.equals(
                other.savedSignoffId));
    }
