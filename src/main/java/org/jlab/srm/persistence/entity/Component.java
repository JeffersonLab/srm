...
@Table(
    schema = "SRM_OWNER",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"DATA_SOURCE"})})
@NamedQueries({
  @NamedQuery(name = "Component.findAll", query = "SELECT c FROM Component c"),
  @NamedQuery(
      name = "Component.findStatus",
      query = "SELECT max(a.status.statusId) FROM GroupSignoff a WHERE a.component = :component")
})
@SqlResultSetMapping(
    name = "ComponentStatus",
    columns = {@ColumnResult(name = "component_id"), @ColumnResult(name = "status_id")})
