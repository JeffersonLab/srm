...
public class BeamDestination implements Serializable {
  ...
  @JoinTable(
      name = "COMPONENT_BEAM_DESTINATION",
      joinColumns = {
        @JoinColumn(
  ...
  public boolean equals(Object object) {
    ...
    return (this.beamDestinationId != null || other.beamDestinationId == null)
  ...
  public String toString() {
    return ".org.jlab.srm.persistence.entityBeamDestination[ beamDestinationId="
        + beamDestinationId
        + " ]";
  }
}
