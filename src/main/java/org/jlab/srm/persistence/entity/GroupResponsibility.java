...
@Table(
    ...
    schema = "SRM_OWNER",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"GROUP_ID", "SYSTEM_ID"})})
public class GroupResponsibility implements Serializable {
  ...
  @SequenceGenerator(
      ...
      sequenceName = "GROUP_RESPONSIBILITY_ID",
      allocationSize = 1)
  ...
  public boolean equals(Object object) {
    ...
    return (this.groupResponsibilityId != null || other.groupResponsibilityId == null)
        && (this.groupResponsibilityId == null
            || this.groupResponsibilityId.equals(other.groupResponsibilityId));
  }

  @Override
  public String toString() {
    return "org.jlab.srm.persistence.entity.GroupResponsibility[ groupResponsibilityId="
