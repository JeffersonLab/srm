...
public class GroupSignoffHistory implements Serializable {
  ...
  @Id
  @SequenceGenerator(
      name = "GroupSignoffHistoryId",
      sequenceName = "GROUP_SIGNOFF_HISTORY_ID",
      allocationSize = 1)
  ...
  public GroupSignoffHistory(
      BigInteger groupSignoffHistoryId,
      BigInteger groupId,
  ...
  public boolean equals(Object object) {
    ...
    return (this.groupSignoffHistoryId != null || other.groupSignoffHistoryId == null)
        && (this.groupSignoffHistoryId == null
            || this.groupSignoffHistoryId.equals(other.groupSignoffHistoryId));
  }

  @Override
  public String toString() {
    return "org.jlab.srm.persistence.entity.GroupSignoffHistory[ groupSignoffHistoryId="
        + groupSignoffHistoryId
        + " ]";
  }
}
