 ...
 */
@Entity
@Table(name = "SAVED_SIGNOFF_TYPE", schema = "SRM_OWNER", uniqueConstraints
        = {
...
public class SavedSignoffType implements Serializable {
    ...
    @NotNull
    @Column(name = "SAVED_SIGNOFF_TYPE_ID", nullable = false, precision = 22, scale
            = 0)
    ...
    public boolean equals(Object object) {
        ...
        return (this.savedSignoffTypeId != null || other.savedSignoffTypeId == null) && (this.savedSignoffTypeId == null || this.savedSignoffTypeId.equals(other.savedSignoffTypeId));
    }
