                    ...
                    <div id="filter-form-panel">
                        <fieldset>
                            ...
                            <ul class="key-value-list">
                                ...
                                <li>
                                    <div class="li-key">
                                        <label for="status-select">Mask Type</label>
                                    </div>
                                    <div class="li-value" style="visibility: hidden;">
                                        <select id="status-select" multiple="multiple" name="statusId"
                                            ...
                                            <c:forEach items="${statusList}" var="status">
                                                <option value="${status.statusId}"${s:inArray(paramValues.statusId, status.statusId.toString()) ? ' selected="selected"' : ''}>
                                                    <c:out value="${status.maskType}"/></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </li>
                    ...
                    <c:if test="${editable}">
                        <s:editable-row-table-controls excludeAdd="${true}" excludeDelete="${true}"
                            ...
                            <button type="button" id="open-edit-exception-button" class="selected-row-action"
                                    disabled="disabled">Edit Mask
                            </button>
                            <button type="button" id="open-remove-exception-button" class="selected-row-action"
                                    disabled="disabled">Remove Mask
                            </button>
                ...
                <form id="unmask-component-form" action="component-list" method="post">
                    <ul class="key-value-list">
                        <li>
                            ...
                            <div class="li-value">
                                <ul id="unmask-selected-row-list"></ul>
                                <span id="unmask-exception-dialog-component-count"></span>
                            </div>
                        </li>
                        <li>
                            <div class="li-key">
                                <label for="unmask-signoff" title="What state should component be in when unmasked?">Status</label>
                            </div>
                            <div class="li-value">
                                <select id="unmask-signoff">
                                    <option value="50">Checked</option>
                                    <option value="100">Not Ready</option>
                                </select>
                            </div>
                        </li>
                        <li>
                    ...
                    <div class="dialog-button-panel">
                        <button type="button" id="unmask-button">Save</button>
                        <button type="button" class="dialog-close-button">Cancel</button>
                    </div>
                </form>
            </div>
