                                        ...
                                        <li>
                                            ...
                                            <div class="li-value">
                                                ...
                                                <a title="Subsystem Information" class="dialog-ready dialog-only"
                                                   data-dialog-title="Subsystem Information: ${fn:escapeXml(checklist.groupResponsibility.system.name)}"
                    ...
                    <c:if test="${editable}">
                        ...
                        <script>
                            tinymce.init({
                                ...
                                content_css: "${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/css/checklist.css",
                                menubar: false,
