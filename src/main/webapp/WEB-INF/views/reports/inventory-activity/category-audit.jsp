...
<c:set var="title" value="Category Activity"/>
    ...
    <jsp:body>
        <section>
            <s:filter-flyout-widget requiredMessage="true">
                <form class="filter-form" method="get" action="category-audit">
                    <fieldset>
            ...
            <h2 class="page-header-title">Inventory Activity: Category <c:out value="${param.categoryId}"/></h2>
            ...
            <c:choose>
                <c:when test="${param.categoryId == null}">
                    <div class="message-box">Choose a category ID to continue</div>
                </c:when>
                ...
                <c:otherwise>
                    ...
                    <table id="revision-table" class="data-table stripped-table">
                        ...
                        <tr>
                            ...
                            <c:forEach items="${revisionList}" var="entity">
                                <td>
                                    <c:out value="${entity.parent.name}"/>
                                </td>
                            </c:forEach>
                        </tr>
                        </tbody>
