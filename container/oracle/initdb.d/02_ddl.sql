...
CREATE TABLE SRM_OWNER.SETTING
(
...
(
    ...
    WEIGHT               INTEGER NULL ,
    ARCHI_LOC            VARCHAR2(20 CHAR) NULL,
    ARCHI_DESC           VARCHAR2(100 CHAR) NULL,
...
(
    ...
    GOAL_PERCENT         SMALLINT DEFAULT 0 NOT NULL,
    LEADER_WORKGROUP     VARCHAR2(64 CHAR) NOT NULL,
    ...
    CONSTRAINT RESPONSIBLE_GROUP_CK1 CHECK (GOAL_PERCENT BETWEEN 0 AND 100),
    CONSTRAINT RESPONSIBLE_GROUP_CK2 CHECK (ARCHIVED_YN IN ('Y', 'N'))
);
...
(
    ...
    COMPONENT_ID         INTEGER NOT NULL ,
    REQUEST_USERNAME     VARCHAR2(64 CHAR) NOT NULL ,
...
(
    ...
    STATUS_ID                INTEGER NOT NULL ,
    MODIFIED_USERNAME        VARCHAR2(64 CHAR) NOT NULL ,
...
CONSTRAINT GROUP_RESPONSIBILITY_AK2 UNIQUE (SYSTEM_ID,WEIGHT) DEFERRABLE INITIALLY DEFERRED,
CONSTRAINT GROUP_RESPONSIBILITY_AK1 UNIQUE (GROUP_ID,SYSTEM_ID),
CONSTRAINT GROUP_RESPONSIBILITY_FK1 FOREIGN KEY (GROUP_ID) REFERENCES SRM_OWNER.RESPONSIBLE_GROUP (GROUP_ID) ON DELETE CASCADE,
...
CREATE UNIQUE INDEX SRM_OWNER.COMPONENT_IN1 ON SRM_OWNER.COMPONENT (DATA_SOURCE, NVL2(DATA_SOURCE_ID, DATA_SOURCE_ID, COMPONENT_ID));

-- Not Unique, so not a constraint; this is purely for performance
CREATE INDEX SRM_OWNER.GROUP_SIGNOFF_IN1 on SRM_OWNER.GROUP_SIGNOFF(COMPONENT_ID, STATUS_ID);
